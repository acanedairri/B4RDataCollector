...
public class VariableSetMasterActivity extends AppCompatActivity
{
	...
	public void onCreate(Bundle paramBundle)
	{
		...
		setContentView(R.layout.activity_variable_set_master);
...
/*		findViewById(R.id.btnSelectTrait).setOnClickListener(new OnClickListener(){
	...
	private void populateVariableSet() {
		...
		adapterVariableSet = new ArrayAdapter<CharSequence>(VariableSetMasterActivity.this, android.R.layout.simple_spinner_item, spinnerArray);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_settings) {
			...
			Intent intent = new Intent(VariableSetMasterActivity.this, GetVariableSetMasterActivity.class);
...
//			Log.d("DEBUG", "TraitCode: " + lstObj.traitCode + " Visible:" + lstObj.is_visible + " AFTER: " + createFieldBookModel.getFieldTraitModel(lstObj.traitCode).visible);
	...
	private void viewLogoutConfirmDialog(){
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(
				VariableSetMasterActivity.this);
